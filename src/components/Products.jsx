...
const CATEGORIES = [
  ...
  { id: '02', name: 'Piping Systems', desc: 'Heavy-duty CPVC and GI piping for secure builds.' },
  { id: '03', name: 'Pump Systems', desc: 'High-performance water solutions for homes and industry.' },
  { id: '04', name: 'Switchgear', desc: 'Modular switches and advanced circuit protection.' },
  { id: '05', name: 'Fans & Lighting', desc: 'Branded circulation and energy-efficient illumination.' },
  { id: '06', name: 'Accessories', desc: 'All essential electrical and plumbing accessories.' }
]
          ...
          {CATEGORIES.map((cat, i) => (
            ...
            >
              <div className="border-b border-brand-black/10 pb-12 group-hover:border-brand-black transition-all">
                <span className="text-[10px] font-mono text-brand-gray-400 mb-8 block">{cat.id}</span>
