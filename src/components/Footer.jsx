        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-12 lg:gap-24 mb-24 pb-24 border-b border-brand-black/5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] font-medium text-brand-gray-400">
              Authorized Wholesalers Since 2013
            </p>
          </div>

          {/* Location Block */}
          <div className="space-y-4">
            <span className="text-[9px] uppercase tracking-[0.4em] font-bold text-brand-gray-400">
              Address
            </span>
          ...
          >
            <span className="text-[9px] uppercase tracking-[0.4em] font-bold text-brand-black">
              Back to Top
            </span>
