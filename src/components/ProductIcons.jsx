  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <circle
        ...
        r="1.5"
        fill="#1a1a1a"
        className={`${on} transition-opacity duration-300 delay-100`}
      />
      <circle
        cx="12"
        cy="15"
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <line
        ...
        strokeWidth="1.3"
        strokeLinecap="round"
        className={`${on} transition-all duration-300 delay-0`}
      />
      <line
        x1="10"
        y1="9"
        ...
        strokeWidth="1.3"
        strokeLinecap="round"
        className={`${on} transition-all duration-300 delay-100`}
      />
      <line
        x1="12"
        y1="9"
        ...
        strokeWidth="1.3"
        strokeLinecap="round"
        className={`${on} transition-all duration-300 delay-200`}
      />
      <line
        x1="14"
        y1="9"
        ...
        strokeWidth="1.3"
        strokeLinecap="round"
        className={`${on} transition-all duration-300 delay-300`}
      />
      <line
        x1="16"
        y1="9"
        ...
        strokeWidth="1.3"
        strokeLinecap="round"
        className={`${on} transition-all duration-300 delay-[400ms]`}
      />
    </svg>
  );
}
